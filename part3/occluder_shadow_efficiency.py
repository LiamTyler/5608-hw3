...
for numEyeSamples in powersOf2:
    ...
    for numLightSamples in powersOf2:
        ...
        baseName  = "occluder_shadow/occluder_shadow_eye_" + str(numEyeSamples) + "_light_" + str(numLightSamples)
        ...
        os.system(cmd)
        cmd = "..\\Release\\exrdiff.exe ..\\..\\..\\..\\HW3\\part3\\scenes\\occluder_shadow_ref.exr " + imageName + " >> " + baseName + "_log.txt"
        os.system(cmd)
